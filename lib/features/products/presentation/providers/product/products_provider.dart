...
class ProductsNotifier extends StateNotifier<ProductsState> {
  ...
  Future<bool> createOrUpdateProduct(Map<String, dynamic> productDto) async {
    try {
      final Product product =
          await productsRepository.createOrUpdateProduct(productDto);
      final bool isProductInList =
